...
export const FOLDER_MOCA_WORKSHOP='2025_MOCA_Workshop';

export const FOLDER_MACAO='2025_MACAO_Exhibition';
export const FOLDER_MACAO_WORKSHOP='2025_MACAO_Workshop';
